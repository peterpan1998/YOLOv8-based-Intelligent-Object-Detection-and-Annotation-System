...
from libs.alertText import AlertText
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        add_actions(self.menus.trans, (v8AutoDetect, splitDataset,xmlToTxt,createyaml,starttrain,coco2voc))
    ...
    def v8AutoDetectClick(self):

        print("子窗口")
        child_window = Child()
        # child_window.button_detect()
        child_window.exec_()

    def splitDatasetClick(self):
        ...
        if self.file_path ==None:
            title = 'Alert  Text         '
            info = "       please select open_dir and change_save_dir !             "
            alertText = QMessageBox()
            alertText.warning(self, title, info)
        else:
            xmlfilepath = self.default_save_dir
            txtsavepath = xmlfilepath.replace('/Annotations','/ImageSets')
    ...
    def  createYamlClick(self):
        ...
        print("create yaml")
        title = 'Alert  Text         '
        info = "       make sure the split_dataset and xml_to_txt are done  !             "
        alertText = QMessageBox()
        alertText.warning(self, title, info)
        alertTxt = AlertText(self.default_save_dir)
        alertTxt.exec_()

    def starttrainClick(self):
        print("start train")
        yolov8train = YOLOv8(self.default_save_dir)
        yolov8train.exec_()
    def coco2vocClick(self):
        print("coco2voc")
        alertTxt = Co2voc()
        alertTxt.exec_()
    ...
    def change_save_dir_dialog(self, _value=False):
        print("change_save_dir_dialog 我执行了")
        if self.default_save_dir is not None:
